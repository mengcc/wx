...
public class MenuManager  {
	    ...
	    public static Menu getMenu() {  
	        ...
	        btn34.setName("永久素材--图片");
	        btn34.setType(MenuType.media_id.name());
	        btn34.setMedia_id("lhoUkuxMu-nnxU3GWkmwqaFXL1K3Q2r_BEIedUTXKVs");
	        
	        MediaButton btn35 = new MediaButton();
	        btn35.setName("永久图文");
	        btn35.setType(MenuType.media_id.name());
	        btn35.setMedia_id("lhoUkuxMu-nnxU3GWkmwqWPXUhrJkzMo761S5kFVUWU");
